...
Scenario: BTC to USD/EUR
 ...
 Then I should see the equivalent "BTC" in "USD"
 And If I change the currency to "EUR"
 Then The calculator should update the "BTC" equivalent in "EUR"
 ...
 And I enter "200" in the input
 Then I should see the equivalent "ETH" in "USD"
 And If I change the currency to "EUR"
 Then The calculator should update the "ETH" equivalent in "EUR"
...
Scenario: Auto-update accordingly with the last price
 ...
 Then The calculator should update the "BTC" equivalent in "USD"